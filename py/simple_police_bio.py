...
def create_analyzer_chain(llm):
    prompt = ChatPromptTemplate.from_messages(
        [
            ...
            ("ai", """{{"thought": "[관찰] 넷플릭스 시청, 긍정적 감정. [기확인 사항] 없음. [해석] [부서·계급·근무형태 조합 파악] dept=여성청소년(감정노동·피해자 보호 특성) + user_rank=경사(실무자로 사건 직접 처리) + shift_type=holiday(휴무). 생체 데이터 활용 ❌: 일상 긍정 대화. 프로필 활용 ✅: 스트레스 탐색 아닌 휴무일 여유를 공감하는 맥락으로만. [다음 응답 방향] 데이터 언급 없이 휴무일 여유를 지지하며 시청 중인 작품을 묻는 가벼운 질문으로 이어갈 것.", "situation": "휴무일 밀린 잠을 자고 여가 생활을 즐기며 온전히 휴식에 집중하고 있는 상태임.", "emotion": {{"main": "편안함", "sub": "만족", "valence": "positive"}}}}"""),
