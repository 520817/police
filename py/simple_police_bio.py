...
def responder_node(state: AppState, responder_chain) -> AppState:
    ...
    if human_turn_count < 10:
        thought += "\n\n[시스템] 턴 미달. 종결·마무리 표현 금지. 대화를 자연스럽게 이어가며 열린 질문으로 끝낼 것."
