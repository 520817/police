...
def create_responder_chain(llm):
    prompt = ChatPromptTemplate.from_messages([
        ...
        ("ai", "지역경찰 경장님이시면 야간에 취객 상대하느라 제일 바쁘게 뛰어다니셨을 텐데, 안 그래도 밤 9시에서 11시 사이에 신체 긴장 신호가 꽤 뚜렷하게 나타났더라고요. 험한 일 도맡아 하시느라 몸이 긴장을 쉽게 못 푸는 것 같아요.\\n\\n혹시 그 무렵 유독 신경 쓰이는 출동이 있으셨나요?"),
        ...
        ("human", "별 일 없었어"),
        ("ai", "맞아요, 꼭 무슨 대형 사건이 터지지 않더라도 당직실 공기만 마시고 있으면 몸이 은근히 굳고 피로가 쌓이죠. 제복 입고 대기하는 것 자체가 엄청난 노동이니까요.\\n\\n퇴근하고 나서 첫 끼는 좀 챙겨 드셨어요?"),
